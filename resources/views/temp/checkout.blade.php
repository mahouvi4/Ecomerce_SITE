                    ...
                    <div class="row">
                        <div class="col-lg-9">
                            <h2 class="checkout-title">Billing Details</h2><!-- End .checkout-title -->
                                ...
                                <input type="text" class="form-control"  name="rue" value="{{session('info_user')[0]->rue}}" placeholder="House number and Street name" required>
                                ...
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <textarea class="form-control" name="adresscommande" placeholder="Notes about your order, e.g. special notes for delivery"></textarea>                                </div><!-- End .custom-checkbox -->

                                <label>Order notes (optional)</label>
                                <textarea class="form-control" name="infosuplement" placeholder="Notes about your order, e.g. special notes for delivery"></textarea>
                        </div><!-- End .col-lg-9 -->
                        <aside class="col-lg-3">
                            <div class="summary">
                                ...
                                @if ($total==0)
                                <a href="{{url('/')}}"><button type="button"class="btn btn-outline-primary-2 btn-order btn-block">
                                    <span class="btn-text">Shopping</span>
                                    <span class="btn-hover-text">Proceed to Shopping</span>
                                   
                                </button>
                            </a>
                                 @else
                                 <a href="{{url('template/show_commande')}}"><button type="button"class="btn btn-outline-primary-2 btn-order btn-block" onclick="store_checkout_x()">
