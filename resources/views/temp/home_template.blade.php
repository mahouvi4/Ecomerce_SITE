...
<main class="main">
                        ...
                        <div class="intro-slider owl-carousel owl-simple owl-dark owl-nav-inside" data-toggle="owl" data-owl-options='{
                                        ...
                                        <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                                            <div class="carousel-inner">
                                              <div class="carousel-item active">
                                                ...
                                                <img class="d-block w-100" src="{{asset('assets/images/demos/demo-3/slider/slide-1.jpg')}}" alt="First slide">

                                            </div>

                                            <div class="carousel-item">
                                                <img class="d-block w-100" src="{{asset('assets/images/demos/demo-3/slider/slide-1.jpg')}}" alt="Second slide">
                                              </div>

                                              <div class="carousel-item">
                                                <img class="d-block w-100" src="{{asset('assets/images/demos/demo-3/slider/slide-1-480w.jpg')}}" alt="Third slide">
                                              </div>
                            ...
                            <div class="intro-slide">
                                <figure class="slide-image">
                                    ...
                                    <div class="carousel-item">
                                        <img class="d-block w-100" src="{{asset('assets/images/demos/demo-3/slider/slide-2.jpg')}}" alt="Second slide">
                                      </div>

                                      <div class="carousel-item">
                                        <img class="d-block w-100" src="{{asset('assets/images/demos/demo-3/slider/slide-2-480w.jpg')}}" alt="Third slide">
                                      </div>
                                </div>
                              </div>
                                    </picture>
                    ...
                    <div class="product product-2">
                        <figure class="product-media">
                            ...
                            <a href="{{url('Template/description/'.$item->id)}}">
                                <img src="{{asset('produit/'.$item->photo)}}" alt="Product image" class="product-image" style="height: 277px;width:277px">
                            </a>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 deal-col">
                    <div class="deal" style="background-image: url('{{asset('assets/images/demos/demo-3/deal/bg-1.jpg')}}');">
                        <div class="deal-top">
                        ...
                        <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                           ...
                           <div class="product product-2">
                            <figure class="product-media">
                                <span class="product-label label-circle label-top">Top</span>
                                <a href="{{url('Template/description/'.$item->id)}}">
                                    <img src="{{asset('produit/'.$item->photo)}}" alt="Product image" class="product-image" style="width: 277px;height:200px">
                                </a>
                            ...
                            <div class="product-body" style="height: 197px">
                                <div class="product-cat">
                                    <a href="#">{{$item->nom}}</a>
                                </div><!-- End .product-cat -->
                                <h3 class="product-title"><a href="product.html">{{$item->reference}}</a></h3><!-- End .product-title -->
        ...
        <div class="tab-content tab-content-carousel just-action-icons-sm">
            <div class="tab-pane p-0 fade show active" id="top-all-tab" role="tabpanel" aria-labelledby="top-all-link">
                ...
                <div class="product product-2">
                    ...
                    <div class="product-body" style="height: 193px">
                        <div class="product-cat">
                            <a href="#">{{$item->nom}}</a>
                        </div><!-- End .product-cat -->
                        <h3 class="product-title"><a href="product.html">{{$item->reference}} </a></h3><!-- End .product-title -->
    ...
    <div class="container">
        <div class="cta cta-separator cta-border-image cta-half mb-0" style="background-image: url('{{asset('assets/images/demos/demo-3/bg-2.jpg')}}');">
            <div class="cta-border-wrapper bg-white">
                <div class="row">
                    <div class="col-lg-6">
