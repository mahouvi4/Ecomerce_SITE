                        ...
                        <ul class="top-menu">
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li class="breadcrumb-item"><a href="{{url('template/all_commande_user_checkout')}}" style="color:darkturquoise">My Shipping</a></li>
                ...
                <div class="container">
                    ...
                    <div class="header-right">
                        ...
                        <div class="wishlist">
                            ...
                            <a href="{{url('template/login_create')}}" title="Wishlist">

                                @else
                                <a href="{{url('template/show_list_like')}}" title="Wishlist">
                        ...
                        <div class="dropdown cart-dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <div class="dropdown-cart-products">
                                    @if(empty(session('info_user')))
                                    <a href="{{url('template/login_create')}}" title="Wishlist"></a>
                                         @else
                                        <div class="smoll">Votre Panier est vide !!</div>
